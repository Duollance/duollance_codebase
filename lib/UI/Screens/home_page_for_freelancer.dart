...
class HomePageForFreelancer extends StatefulWidget {
  const HomePageForFreelancer({super.key});

  @override
  State<HomePageForFreelancer> createState() => _HomePageForFreelancerState();
}

class _HomePageForFreelancerState extends State<HomePageForFreelancer> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Expanded(
                child: FancyText(
                  'Select your core profession, skill or niche ',
                  textColor: Colors.white,
                  size: 24.sp,
